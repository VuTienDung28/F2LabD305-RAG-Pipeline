# Study FAQs - RMIT University

**Source:** https://www.rmit.edu.vn/libraryvn/student-support/study-faq
**Crawled:** 2026-08-04T03:30:08.202778+00:00
**Type:** news
...
[Home](/) / [The RMIT Vietnam Library](/libraryvn) / [Student support](/libraryvn/student-support) / [Study FAQs](/libraryvn/student-support/study-faq)

## Evaluating sources

[Expand all sections](javascript:void(0))

## Are newspaper articles and trade journal articles reliable to use?
...
To learn more about how to Evaluate Sources, see this [library tutorial](https://rmit.libguides.com/c.php?g=924814&p=6678319).

To understand What's a scholarly source, watch this [video](https://www.youtube.com/watch?v=mmJlV642eTo&t=1s&ab_channel=RMITUniversityLibraryVideos).

## Which sources can I use for my assignment?
...
For more information, see this library guide on [Information Search Process](https://rmit.libguides.com/library-research/process).

## What is considered a scholarly/academic source?
...
To understand more about What's a scholarly source, watch this [video](https://www.youtube.com/watch?v=mmJlV642eTo&t=1s&ab_channel=RMITUniversityLibraryVideos).

## What is peer-reviewed and how peer-reviewed is different from other sources?
...
For more questions of the test, see [guide on Evaluation Criteria](https://rmit.libguides.com/ld.php?content_id=43851276).

## Is information from .com websites academic?
...
## Is peer-reviewed source an academic source?
...
## Are all the resources in the library databases academic/scholarly?
...
## How can I check if a journal is peer-reviewed?
...
* Step 1: Access to [UlrichsWeb database](https://rmitlibraryvn.rmit.edu.vn/permalink/84RVI_INST/1kigfja/alma991001228102406821).
...
For more support, [book a Consultation with a Librarian](https://outlook.office365.com/owa/calendar/RMITVietnamLibraryConsultationwithLibrarian@rmiteduau.onmicrosoft.com/bookings/).

## Are all the resources in Google Scholar peer-reviewed/scholarly?
...
## How do I reference a moodboard?
...
To create full citations, go to the online referencing guide [EasyCite](https://www.lib.rmit.edu.au/easy-cite/) or [RMIT Havard referencing printable guide](https://www.rmit.edu.au/library/study/referencing).

## How do I reference a source written in Vietnamese?
...
1. Go to EasyCiteor [RMIT Havard referencing printable guide](https://www.rmit.edu.au/library/study/referencing).
...
For further support, [book a consultation with a librarian](https://outlook.office365.com/owa/calendar/RMITVietnamLibraryConsultationwithLibrarian@rmiteduau.onmicrosoft.com/bookings/).

## How do I create an Appendix?
...
[Report writing process](https://emedia.rmit.edu.au/learninglab/content/post-graduate-reports) (RMIT – Study and Learning Center)

[Australian Government Style Manual (AGSM)](https://www.stylemanual.gov.au/content-types/reports)

## How do I reference a source that was translated?
...
Source: [Australian Government Style Manual (AGSM)](https://www.stylemanual.gov.au/referencing-and-attribution/author-date)

## How do I reference pen names?
...
2. In the reference list, list according to the pen name or pseudonym and include the author’s actual in parentheses if known. E.g., Mari (Maria Giovanna Colli) (2009) *Bilbao\_6: Guggenheim Museum Bilbao* [photograph], Flickr, Copyright 2009 by Mari, CC BY 2.0, accessed 13 December 2021. https://www.flickr.com/ photos/ 52355315@N08/5757476385/in/album-72157626677144865/

Source:[RMIT Havard referencing printable guide](https://www.rmit.edu.au/library/study/referencing)

## How do I reference a screenshot from a Youtube video?
...
* Go to [EasyCite](https://www.lib.rmit.edu.au/easy-cite/)or [RMIT Havard referencing printable guide](https://www.rmit.edu.au/library/study/referencing)
* Choose item type Audiovisual materials - sub-type Streaming video / YouTube video for the reference list rules as well as examples.

For further support, [book a consultation with a librarian.](https://outlook.office365.com/owa/calendar/RMITVietnamLibraryConsultationwithLibrarian@rmiteduau.onmicrosoft.com/bookings/)

## How do I reference information from a LinkedIn Learning course?

LinkedIn Learning courses are considered online videos.

To reference a LinkedIn Learning course:

1. Go to [EasyCite](https://www.lib.rmit.edu.au/easy-cite/)or [RMIT Havard referencing printable guide](https://www.rmit.edu.au/library/study/referencing).
...
## How can I import my survey into my report?
...
[Report writing process](https://emedia.rmit.edu.au/learninglab/content/post-graduate-reports)
...
## How can I reference an abbreviation of corporate author name?
...
## How do I reference a picture I took?
...
## How do I shorten a long title in in-text citation?
...
## What is the referencing style applied at RMIT Vietnam University?
...
## What is an edited book? How do I find a book chapter in the library collection?

Edited books are books that include chapters written by different authors.

How to find book chapters:

1. In [LibrarySearch](/libraryvn) box, put in your search terms i.e. Chapter title => click Search.
2. Under the filter Resource Type, choose Book Chapters.

For more information, watch this [video](https://www.youtube.com/watch?v=WvQiyQ8Smtc&ab_channel=RMITVNLibrary).

## How can I include/exclude certain words or phrases in my searches?
...
For more information on search tips, see this [library guide](https://rmit.libguides.com/c.php?g=924814&p=6725422).

## How do I search for peer-reviewed/academic sources?

To search for peer-reviewed sources, you can try these ways:

* Option 1: In [LibrarySearch](/libraryvn) box, put in your search terms => select Search. Under the filter Availability, choose 'Peer-reviewed Journals'.
* Option 2: Search [Google Scholar](https://login.ezproxy.lib.rmit.edu.au/login?url=https://scholar.google.com.au) for a range of scholarly resources. Google Scholar search results will include resources from the RMIT Library online collections. However, Google Scholar search results may include publications that are not scholarly.
* Option 3: Access the library databases and search for the expected articles as some articles are not input in LibrarySearch. E.g., ProQuest, JSTOR, Wiley. See list of [library databases](https://www.rmit.edu.au/library/borrowing-and-collections/collections/databases#news).

For more information, see these library guides [Scholarly Source](https://youtu.be/mmJlV642eTo) and [using Google Scholar](https://www.rmit.edu.au/library/help/using-google-scholar).

## How do I search for specific type of materials e.g. books/articles/audio/videos?

How to find books:

1. In [LibrarySearch](/libraryvn) box, put in your search terms => select Search.
...
For more information, see the [Industry and Company Information subject guide](https://rmit.libguides.com/companyandindustryinfo).

For further support, book a [Consultation with a Librarian](https://outlook.office365.com/owa/calendar/RMITVietnamLibraryConsultationwithLibrarian@rmiteduau.onmicrosoft.com/bookings/).

## How do I distinguish market reports vs industry reports?
...
[Marketing & Martket Research](https://rmit.libguides.com/marketing_research) and [Industry & Company Information](https://rmit.libguides.com/companyandindustryinfo).

## How do I distinguish webpage documents vs reports vs newspaper articles?
...
## Where do I find information on the supply chain e.g., suppliers of products?
...
## Does RMIT Library provide access to Euromonitor International (Passport) database?
...
3. Under Full text availability, click on [Passport](https://www.portal.euromonitor.com/portal/analytics/index) to access the database.

Tip: see Passport [Help and Guide Videos](https://www.portal.euromonitor.com/portal/help/home) for efficient searches.

For more information, see the library website [Databases](https://www.rmit.edu.au/library/borrowing-and-collections/collections/databases#news).

## How can I access Statista off campus?

To access Statista off-campus:

1. Create an account on [statista.com/register](http://statista.com/register):
...
 For further support, contact us at [library@rmit.edu.vn](mailto:library@rmit.edu.vn) or use the Chat service.

## How can I access WGSN?

To access WGSN:

Search for ‘WGSN’ on the library website, or via this [link](https://rmitlibraryvn.rmit.edu.vn/permalink/84RVI_INST/1kigfja/alma991001238668206821).
...
For off-campus support, contact [collection.support@rmit.edu.au](mailto:collection.support@rmit.edu.au)

## Can I access databases off-campus?

Yes. Visit the [library website](/libraryvn) and search for the database name in the search box e.g., EBSCO, ProQuest, JSTOR.  Under ‘Online Access’ option, select the link to the database, then log in to access the database off-campus.

## Are all the resources in databases academic/scholarly?

Not all the resources in the databases are academic/scholarly. Some databases provide both academic and popular sources, such as videos, images, and newspaper articles. When searching in library databases, you may apply filter ‘peer-reviewed’ articles to get academic/scholarly materials.

## What if I can't get full-text access to the articles that I found in some databases?

If you can’t get full-text access to the articles that you found, try these options:

* Search for the articles in [LibrarySearch](/libraryvn) to check whether other databases in the library can provide you with full text access.
* Search for the article through [RMIT Melbourne Library](https://www.rmit.edu.au/library) for access.
...
You can access LinkedIn Learning through [this link](https://rmitlibraryvn.rmit.edu.vn/permalink/84RVI_INST/1kigfja/alma991001234925406821) or search for ‘LinkedIn Learning’ via the [Library website](/libraryvn).
...
## How can I check peer-reviewed status of journals?

You can use UlrichsWeb Global Serials Directory (log in with your RMIT account when required) to check peer-reviewed status of a journal in three steps.

* Step 1: Access to UlrichsWeb database via this [link](http://ulrichsweb.serialssolutions.com.ezproxy.lib.rmit.edu.au/).
* Step 2: Search for the journal using title, ISSN or keyword.
* Step 3: Check the status of the journal whether it is 'Refereed'.

For support, book a [Consultation with a Librarian](https://outlook.office365.com/owa/calendar/RMITVietnamLibraryConsultationwithLibrarian@rmiteduau.onmicrosoft.com/bookings/).

## How can I access Harvard Business Review online?

The Library provides access to a range of newspapers and magazines. To access, you can search for the name of the newspaper/magazine using the [Library website](/libraryvn). Harvard Business Review magazine can be accessed through the library database EBSCO via [this link.](https://rmitlibraryvn.rmit.edu.vn/permalink/84RVI_INST/1kigfja/alma991001237996506821)

## Where do I find the overall information of RMIT library databases?

RMIT Library has subscribed for over 600 databases of which users can find ebooks, journals, news, data, videos and images. You can find further instructions on searching for resources on your topics through the [library website](https://rmitlibraryvn.rmit.edu.vn/permalink/84RVI_INST/1kigfja/alma991001237996506821).

## What are the key databases providing access to RMIT ebook collections?

RMIT Library holds about 500,000 ebooks of various topics in databases. You can access the list of RMIT ebooks through [RMIT Library collection guides](https://rmit.libguides.com/ebooks/ebookcollections).

## Google Scholar

[Expand all sections](javascript:void(0))

## How do I access full text articles via Google Scholar?
...
[Go to Google Scholar (no access to Google account)](https://login.ezproxy.lib.rmit.edu.au/login?url=https://scholar.google.com.au).
...
[Go to Google Scholar (with access to Google account)](https://scholar.google.com.au/).
...
To understand more about What's a scholarly source, watch this [video](https://www.youtube.com/watch?v=mmJlV642eTo&ab_channel=RMITUniversityLibraryVideos).

## What are some tips I can use to search in Google Scholar?

For some Google Scholar tips, check this [link](https://scholar.google.com/intl/en/scholar/help.html).

![library-teacher-support-header.jpg](/assets/vn/en/assets-for-production/images/libraryvn-site/library-homepage/library-teacher-support-header.jpg)
...
* [Teacher support](/libraryvn/teacher-support)
* [Researcher support](/libraryvn/researcher-support)
* [Library resources](/libraryvn/borrowing-and-resources/library-resources)
* [Book a study room](/libraryvn/student-support/book-a-study-room)
* [Hours and locations](/libraryvn/about-us/hours-and-locations)
